...
var ResultsContainer = React.createClass ({
  ...
  render: function () {
    var artistResults = this.props.artistResults.map(function(result, index){
        return <ArtistResult key={result.uri} result={result} ajaxRequest={this.props.ajaxRequest} origin={this.props.origin} query={this.props.query} queryType={this.props.queryType} />
      }.bind(this));
    ...
    var albumResults = this.props.albumResults.map(function(result, index){
        return <AlbumResult key={result.uri} ajaxRequest={this.props.ajaxRequest} result={result} origin={this.props.origin} query={this.props.query} queryType={this.props.queryType} />
      }.bind(this));
